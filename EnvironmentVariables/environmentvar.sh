...
echo "Your current directory: $PWD"  # : Shows the working directory you are currently in.
echo "Your shell: $SHELL"  # : Specifies the shell program the user is using.
echo "Your editor: $EDITOR"  # : Specifies the user's preferred text editor.
